...
function scoreDomain(domain, browser) {
  ...
  const serverPenalty = serverHealth.ok === false ? 100000 : 0;
  const browserPenalty = browserReachable ? 0 : 200000;
  return { available, browserReachable, serverHealth, browserLatency, score: browserPenalty + serverPenalty + browserLatency };
}
